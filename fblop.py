...
def show_program():
 ...
 ------------------------------------------------------
    ...
    Author     Reaper 'bmhacker'
    Name       FB LOP 'Open Source Information Facebook'
    CodeName   bmhacker
    version    full version
    Date       07/05/2020 12:50:12
    Team       BMHackers
    Email      bmh1cker@gmail.com
    Telegram   @BMHacker
...
def menu_reaction_ask():
  try:
	...
	cek = raw_input(R + 'FBLOP' + W + '/' + R + 'Bot' + W + '/' + R + 'Reaction' + W + ' >> ')
...
def bot():
  try:
	...
	cek = raw_input(R + 'FBLOP' + W +'/' + R +'Bot ' + W + '>> ')
